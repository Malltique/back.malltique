...
export const SELECT_CATEGORY_BY_ID = (id: number) =>
    ["SELECT * FROM Categories WHERE id = :id", { id }] as const;
...
export const UPDATE_CATEGORY_BY_ID = (id: number, payload: object) =>
    [
...
export const DELETE_CATEGORY_BY_ID = (id: number) =>
    ["DELETE FROM Categories WHERE id = :id", { id }] as const;
